...
func (c *Client) UploadOrUpdateFile(
	...
	req, err := http.NewRequestWithContext(ctx, method, uploadURL, bodyData)
	if err != nil {
...
func (c *Client) UpdateFile(ctx context.Context, bucketId string, relativePath string, data io.Reader, fileOptions ...FileOptions) (FileUploadResponse, error) {
	return c.UploadOrUpdateFile(ctx, bucketId, relativePath, data, true, fileOptions...)
}
...
// relativePath path The file path, including the file name. Should be of the format `folder/subfolder/filename.png`
// data io.Reader The file data
func (c *Client) UploadFile(ctx context.Context, bucketId string, relativePath string, data io.Reader, fileOptions ...FileOptions) (FileUploadResponse, error) {
	return c.UploadOrUpdateFile(ctx, bucketId, relativePath, data, false, fileOptions...)
}
...
func (c *Client) MoveFile(ctx context.Context, bucketId string, sourceKey string, destinationKey string) (FileUploadResponse, error) {
	...
	req, err := c.NewRequest(ctx, http.MethodPost, moveURL, &jsonBody)
	if err != nil {
		return FileUploadResponse{}, err
	}
...
func (c *Client) CreateSignedUrl(ctx context.Context, bucketId string, filePath string, expiresIn int) (SignedUrlResponse, error) {
	...
	req, err := c.NewRequest(ctx, http.MethodPost, signedURL, &jsonBody)
	if err != nil {
...
// bucketId string The bucket id
// filePath path The file path, including the file name. Should be of the format `folder/subfolder/filename.png`
func (c *Client) CreateSignedUploadUrl(ctx context.Context, bucketId string, filePath string) (SignedUploadUrlResponse, error) {
	signUploadURL := c.clientTransport.baseUrl.String() + "/object/upload/sign/" + bucketId + "/" + filePath
	emptyBody := struct{}{}

	req, err := c.NewRequest(ctx, http.MethodPost, signUploadURL, &emptyBody)
	if err != nil {
...
func (c *Client) UploadToSignedUrl(ctx context.Context, filePath string, fileBody io.Reader) (*UploadToSignedUrlResponse, error) {
	...
	req, err := http.NewRequestWithContext(ctx, http.MethodPut, uploadToSignedURL, bodyRequest)
	if err != nil {
		return nil, err
	}
...
func (c *Client) RemoveFile(ctx context.Context, bucketId string, paths []string) ([]FileUploadResponse, error) {
	...
	req, err := c.NewRequest(ctx, http.MethodDelete, removeURL, &jsonBody)
	if err != nil {
		return []FileUploadResponse{}, err
	}
...
func (c *Client) ListFiles(ctx context.Context, bucketId string, queryPath string, options FileSearchOptions) ([]FileObject, error) {
	...
	req, err := c.NewRequest(ctx, http.MethodPost, listFileURL, &body)
	if err != nil {
...
// filePath string The file path, including the file name. Should be of the format `folder/subfolder/filename.png`
// urlOptions UrlOptions The URL options
func (c *Client) DownloadFile(ctx context.Context, bucketId string, filePath string, urlOptions ...UrlOptions) ([]byte, error) {
	var options UrlOptions
	renderPath := "object"
	if len(urlOptions) > 0 {
		options = urlOptions[0]
	...
	req, err := c.NewRequest(ctx, http.MethodGet, buildUrlWithOption(urlStr, options), nil)
	if err != nil {
		return nil, err
	}
