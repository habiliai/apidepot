...
func (c *Client) ListBuckets(ctx context.Context) ([]Bucket, error) {
	...
	req, err := c.NewRequest(ctx, http.MethodGet, bucketsURL, nil)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetBucket(ctx context.Context, id string) (Bucket, error) {
	...
	req, err := c.NewRequest(ctx, http.MethodGet, bucketURL, nil)
	if err != nil {
		return Bucket{}, err
	}
...
func (c *Client) CreateBucket(ctx context.Context, id string, options BucketOptions) (Bucket, error) {
	...
	req, err := c.NewRequest(ctx, http.MethodPost, createBucketURL, &bodyData)
	if err != nil {
		return Bucket{}, err
	}
...
func (c *Client) UpdateBucket(ctx context.Context, id string, options BucketOptions) (MessageResponse, error) {
	bucketURL := c.clientTransport.baseUrl.String() + "/bucket/" + id
	bodyData := map[string]interface{}{
		"id":     id,
		"name":   id,
	...
	req, err := c.NewRequest(ctx, http.MethodPut, bucketURL, &bodyData)
	if err != nil {
...
func (c *Client) EmptyBucket(ctx context.Context, id string) (MessageResponse, error) {
	bucketURL := c.clientTransport.baseUrl.String() + "/bucket/" + id + "/empty"
	jsonBody, _ := json.Marshal(map[string]interface{}{})
	req, err := c.NewRequest(ctx, http.MethodPost, bucketURL, &jsonBody)
	if err != nil {
		return MessageResponse{}, err
	}
...
func (c *Client) DeleteBucket(ctx context.Context, id string) (MessageResponse, error) {
	bucketURL := c.clientTransport.baseUrl.String() + "/bucket/" + id
	jsonBody, _ := json.Marshal(map[string]interface{}{})
	req, err := c.NewRequest(ctx, http.MethodDelete, bucketURL, &jsonBody)
	if err != nil {
		return MessageResponse{}, err
	}
